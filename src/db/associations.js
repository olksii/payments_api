...
// 	try {
// 		const paymentType = await PaymentType.create({name: 'Расходные товары для офиса', description: 'Расходные товары для офиса'});
// 		console.log('documentStatus', paymentType);
// 	} catch (error) {
